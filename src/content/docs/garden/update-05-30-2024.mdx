...
import scapes3 from '../../../assets/garden/scapes-3.png';
...
Our scapes aren't quite ready yet, we've only been able to harvest 1. But we should be able to enjoy a nice garlic scape pesto in the next few weeks 😁

<Image src={scapes3} alt="image of a single garlic scape on a counter top"/>
