...
The party met with Lyra Lullwind who asked if the party would help rescue slaves from the "Sea Sword" and capture the ships captain for 100 platinum (1000 gold) each. She gave them each an advance of 5 platinum for supplies.
...
- Zara's guards pickup the items they asked the party to find for them for 150g gold for each (1500 gold total)
	...
	- bag of holding
	- amulet of life
	- 2 scrolls of guiding bolt (100 gold each)
	- 20 arrows of radiance (100 gold for each set of 5)
